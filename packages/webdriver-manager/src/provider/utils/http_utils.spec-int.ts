...
const binaryUrl = httpBaseUrl + '/test/support/files/bar.zip';
const fooJsonUrl = httpBaseUrl + '/test/support/files/foo_json.json';
const fooArrayUrl = httpBaseUrl + '/test/support/files/foo_array.json';
const fooXmlUrl = httpBaseUrl + '/test/support/files/foo.xml';
